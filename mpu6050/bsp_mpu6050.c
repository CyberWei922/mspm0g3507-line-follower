...
/*
 * The MPU6050 bus remains below its 400 kHz limit while avoiding an
 * unnecessarily long DMP firmware upload. Three microseconds per SCL
 * half-period is a conservative software-I2C setting on this board.
 */
#define MPU6050_I2C_HALF_PERIOD_US (3UL)
...
void I2C_Stop(void)
{
        ...
        SCL(1);
        delay_us(MPU6050_I2C_HALF_PERIOD_US);
        SDA(1);
        delay_us(MPU6050_I2C_HALF_PERIOD_US);
