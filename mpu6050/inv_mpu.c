...
/*
 * Actual vehicle installation:
 *   - the MPU6050 component side faces upward;
 *   - sensor +X points toward the rear of the car;
 *   - sensor +Y points toward the right side of the car;
 *   - sensor +Z points upward.
 *
 * The vehicle frame is +X forward, +Y left, +Z upward, so this is a
 * 180-degree rotation around Z. Left yaw is positive and right yaw is
 * negative.
 */
...
void mget_ms(unsigned long *time)
{
    ...
    {
        /*
         * MotionApps timestamps are metadata only in this project. Return a
         * defined value instead of leaving stack data uninitialized; control
         * timing is owned by the car main loop.
         */
        *time = 0UL;
    }
}
